...
class FormNivelPerdido(Form):
    def __init__(self, screen, x, y, w, h, active, path_image):
        ...
        self._btn_reintentar = Button_Image(screen=self._slave,
                                        ...
                                        onclick_param = "jugar",
                                        path_image = "Formularios\Recursos GUI\Botones/reintentar.png")
        ...
        self.label_titulo = Label(self._slave, 130, 0, 420, 100, "GAME OVER", "Comic Sans", 30, "Black", "Formularios\Recursos GUI\casilla_2.png")
