...
class FormNivelCompletado(Form):
    def __init__(self, screen, x, y, w, h, active, path_image, puntuacion_jugador, nombre_nivel):
        ...
        self.label_titulo = Label(self._slave, 130, 0, 420, 100, "NIVEL COMPLETADO", "Comic Sans", 30, "Black", "Formularios\Recursos GUI\casilla_2.png")
        self.label_puntuacion = Label(self._slave, 100, 120, 480, 100, f"¡HAZ OBTENIDO {self.puntuacion_jugador} PUNTOS!", "Comic Sans", 20, "White", "Formularios\Recursos GUI\casilla_3.png")
        self.label_pedir_nombre = Label(self._slave, 100, 240, 480, 100, "INGRESE SU NOMBRE:", "Comic Sans", 20, "White", "Formularios\Recursos GUI\casilla_3.png")
        ...
        self._btn_guardar = CheckBox(screen=self._slave, master_x = x, master_y = y, x = 405, y = 350, w = 80, h = 80,
                                        path_image_on= "Formularios\Recursos GUI\Botones\guardar_2.png", path_image_off= "Formularios\Recursos GUI\Botones\guardar_1.png")
        ...
        self._btn_home = Button_Image(screen=self._slave,
                                        ...
                                        onclick_param = "home",
                                        path_image = "Formularios\Recursos GUI\Botones\home.png")
