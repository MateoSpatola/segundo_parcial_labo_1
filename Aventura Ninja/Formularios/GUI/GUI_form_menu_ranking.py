...
class FormMenuRanking(Form):
    def __init__(self, screen, x, y, w, h, active, path_image, lista_puntajes, margen_y, margen_x, espacio):
        ...
        self.label_titulo = Label(self._slave, 130, 0, 420, 100, "RANKING", "Comic Sans", 30, "Black", "Formularios\Recursos GUI\casilla_2.png")

        lbl_nivel = Label(self._slave, x= 70, y= 140, w= 170, h= 80, text= "NIVEL",
                        font= "Comic Sans", font_size= 25, font_color= "White", path_image= "Formularios\Recursos GUI\casilla_3.png")
            ...
            for j in self._lista_puntajes:
                ...
                for n,s in j.items():
                    ...
                    item = Label(self._slave, pos_inicial_x, pos_inicial_y, 170, 50, cadena, "Comic Sans", 20,
                                    "White", "Formularios\Recursos GUI\casilla_3.png")
                    self.lista_widgets.append(item)
                    pos_inicial_x += 185
                pos_inicial_y += 50 + espacio
        except:
            self.label_no_hay_datos = Label(self._slave, 100, 250, 480, 120, "No hay datos para mostrar", "Comic Sans", 20, "White", "Formularios\Recursos GUI\casilla_3.png")
