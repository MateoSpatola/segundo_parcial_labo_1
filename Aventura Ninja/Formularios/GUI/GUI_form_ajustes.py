...
class FormAjustes(Form):
    def __init__(self, screen, x, y, w, h, active, path_image):
        ...
        self.label_titulo = Label(self._slave, 130, 0, 420, 100, "AJUSTES", "Comic Sans", 30, "Black", "Formularios\Recursos GUI\casilla_2.png")
        self._btn_musica = CheckBox(screen=self._slave, x = 95, y = 120, master_x = x, master_y = y, w = 100, h = 100,
                                    path_image_on= "Formularios\Recursos GUI\Botones\musica_2.png", path_image_off= "Formularios\Recursos GUI\Botones\musica_1.png")
        self.slider_volumen_musica = Slider(self._slave, x, y, 210, 160, 250, 15, self.volumen_musica, "Green", "White")
        self.label_volumen_musica = Label(self._slave, 480, 143, 100, 50, "10%", "Comic Sans", 15, "Black", "Formularios\Recursos GUI\casilla_1.png")
        self._btn_sonidos = CheckBox(screen=self._slave, x = 95, y = 250, master_x = x, master_y = y, w = 100, h = 100,
                                        path_image_on= "Formularios\Recursos GUI\Botones\sonidos_2.png", path_image_off= "Formularios\Recursos GUI\Botones\sonidos_1.png")
        self.slider_volumen_sonidos = Slider(self._slave, x, y, 210, 290, 250, 15, self.volumen_sonidos, "Green", "White")
        self.label_volumen_sonidos = Label(self._slave, 480, 273, 100, 50, "50%", "Comic Sans", 15, "Black", "Formularios\Recursos GUI\casilla_1.png")
        self._btn_salir = Button_Image(screen=self._slave, x = 290, y = 400, master_x = x, master_y = y, w = 100, h = 100,
                                    onclick = self.btn_salir_click, onclick_param = "home", path_image = "Formularios\Recursos GUI\Botones\salir.png")
    ...
    def update_volumen_sonidos(self, lista_eventos):
        ...
        #pygame.mixer.music.set_volume(self.volumen_sonidos)
