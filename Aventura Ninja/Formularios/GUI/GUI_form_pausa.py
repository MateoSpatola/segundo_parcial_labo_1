...
class FormPausa(Form):
    def __init__(self, screen, x, y, w, h, active, path_image):
        ...
        self._btn_jugar = Button_Image(screen=self._slave,
                                        ...
                                        onclick_param = "jugar",
                                        path_image = "Formularios\Recursos GUI\Botones\jugar.png")
        
        self.btn_ajustes = Button_Image(self._slave, x, y, 290, 400, 100, 100, "Formularios\Recursos GUI\Botones/ajustes.png", self.btn_ajustes_click, "Ajustes")
        
        self.label_titulo = Label(self._slave, 130, 0, 420, 100, "JUEGO PAUSADO", "Comic Sans", 30, "Black", "Formularios\Recursos GUI\casilla_2.png")
