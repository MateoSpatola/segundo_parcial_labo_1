...
class FormSeleccionNivel(Form):
    def __init__(self, screen, x, y, w, h, active, path_image):
        ...
        self._btn_nivel_1 = Button_Image(screen=self._slave,
                                        ...
                                        path_image = "Formularios\Recursos GUI\Botones/1.png")
        ...
        self._btn_nivel_2 = Button_Image(screen=self._slave,
                                        ...
                                        path_image = "Formularios\Recursos GUI\Botones/2.png")
        ...
        self._btn_nivel_3 = Button_Image(screen=self._slave,
                                        ...
                                        path_image = "Formularios\Recursos GUI\Botones/3.png")
        ...
        self.label_titulo = Label(self._slave, 130, 0, 420, 100, "SELECCIONAR NIVEL", "Comic Sans", 30, "Black", "Formularios\Recursos GUI\casilla_2.png")
